...
class Server(object):
    ...
    * self.room: one of 0, 1, 2, 3. This signifies which "room" the client is in,
    ...
    def room_description(self, room_number):
        ...
        return [
            "You are in the room with the giant gold mirror.",
            "You are in the room with the Elvis painting on black velvet.",
            "You are in the room with the Spongebob wallpaper",
            "You are in the room with the green fan light."
        ][room_number]
